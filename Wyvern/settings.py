...
Generated by 'django-posters startproject' using Django 3.1.5.
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'WyvernPosters/media')
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "villalf19@gmail.com"
EMAIL_HOST_PASSWORD = "jarviz199922"